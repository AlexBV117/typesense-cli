                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        fsPromises
                            ...
                            fsPromises
                                .writeFile(process.env.HOME + "/.typesense-cli/typesense-cli.config.json", _this.settings)
                                .then(function (error) { return __awaiter(_this, void 0, void 0, function () {
                                var set;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            return [4 /*yield*/, fsPromises.open(process.env.HOME + "/.typesense-cli/typesense-cli.config.json", "r")];
                                        case 1:
                                            set = _a.sent();
                            ...
                            fsPromises
                                .writeFile(process.env.HOME + "/.typesense-cli/schemas.json", _this.schemas)
                                .then(function (error) { return __awaiter(_this, void 0, void 0, function () {
                                var sch;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            return [4 /*yield*/, fsPromises.open(process.env.HOME + "/.typesense-cli/schemas.json", "r")];
                                        case 1:
                                            sch = _a.sent();
